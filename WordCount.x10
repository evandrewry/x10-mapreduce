...
public class WordCount {
    ...
    public static def main(args:Array[String]{self.rank == 1}) {
        ...
        input_set_1.put(4, str2);
        input_set_1.put(5, str2);
        input_set_1.put(6, str3);
        input_set_1.put(7, str2);
        input_set_1.put(8, str2);
        input_set_1.put(9, str1);
        input_set_1.put(10, str2);
        input_set_1.put(11, str2);
        input_set_1.put(12, str2);
        input_set_1.put(13, str2);
        input_set_1.put(14, str3);
        input_set_1.put(15, str2);

        val input_set_2 = new HashMap[Int, String]();        
        input_set_2.put(1, str4);
        input_set_2.put(2, str5);
        input_set_2.put(3, str6);
        input_set_2.put(4, str4);
        input_set_2.put(5, str4);
        input_set_2.put(6, str4);
        input_set_2.put(7, str4);
        input_set_2.put(8, str3);
        input_set_2.put(9, str4);
        input_set_2.put(10, str4);
        input_set_2.put(11, str1);

        val input_set_3 = new HashMap[Int, String]();        
        input_set_3.put(1, str7);
        input_set_3.put(2, str2);
        input_set_3.put(3, str3);        
        input_set_3.put(4, str3);        
        input_set_3.put(5, str3);        
        input_set_3.put(6, str2);        
